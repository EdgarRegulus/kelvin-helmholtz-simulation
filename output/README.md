...
Por limitaciones de almacenamiento, este repositorio **no incluye todas las salidas generadas por la simulación**. Para reproducir completamente los resultados y obtener los archivos de salida necesarios para el análisis y las visualizaciones, es necesario **compilar y ejecutar el código principal `Euler2D.f95`**, el cual genera automáticamente los datos utilizados por los scripts de post-proceso.
